...
def loadnem(url):
    ...
    if req.status_code != 200:
        return None
    return req.json()
openai.api_key = "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"
...
with st.container():
    ...
    with left_column:
        ...
        if st.button("Click to run"):
            heading_var = "Basic Analysis of " + str(user_input)
            document.add_heading(heading_var)
            paragraph = document.add_paragraph(cool_ai_stuff(user_input))
